        ...
        <form class="flex  gap-x-6  justify-end items-end  ">
            ...
            <div class="w-full">
                ...
                <div class="relative">
                    ...
                    <input type="search" id="default-search" class="block outline-none w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg  bg-neutral-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Marticule" required>
            ...
            <tbody>
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700  hover:bg-neutral-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4 flex gap-x-1 justify-end text-right">
                        <a href="#" data-popover-target="popover" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">See</a>
